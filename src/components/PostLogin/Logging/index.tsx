...
const Logs = ({session}) => {
  ...
  return (
    <>
      <Header heading={t('page:logs')} />
      <div className='min-h-screen text-gray-900'>
        <main className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4'>
          <div className='mt-6 flex flex-col gap-8'>
            <div className='flex flex-col shadow-md rounded-md overflow-hidden'>
              <h3 className='text-lg col-span-12 font-bold text-gray-500 bg-gray-100 px-6 py-3 justify-between flex'>
                {t('common:generation_filter')}
                <button
                  className='text-mainGreen duration-200'
                  onClick={() => {
