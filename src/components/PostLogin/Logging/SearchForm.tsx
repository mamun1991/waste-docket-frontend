...
const SearchForm = ({setSearchFilter, isLoading}) => {
  ...
  return (
    <div className='shadow-md rounded-md overflow-hidden'>
      <h3 className='text-lg col-span-12 font-bold text-gray-500 bg-gray-100 px-6 py-3'>
        ...
        {({values}) => (
          <Form className='grid grid-cols-12 gap-2 px-6 py-3 text-center sm:text-left'>
            ...
            <div className='col-span-12 flex gap-2 flex-wrap justify-center sm:justify-start'>
              ...
              shadow-sm placeholder-gray-400 focus:outline-none focus:ring-mainGreen
              focus:border-mainGreen sm:text-sm'
              />
              <Field
                type='text'
                name='logId'
            ...
            <div className='col-span-12 flex gap-4 justify-center sm:justify-start'>
              <button
                disabled={isLoading}
                type='submit'
                className='bg-mainGreen border border-transparent rounded-md shadow-sm py-2 px-4 inline-flex justify-center text-sm font-medium text-white  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 disabled:opacity-25'
              >
                {t('common:Submit')}
              </button>
              <button
