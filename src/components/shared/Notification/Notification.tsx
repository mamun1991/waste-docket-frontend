...
const Notification = () => {
  ...
  return message ? (
    <Transition appear show={reveal} className='fixed w-full h-full'>
      <div className=' px-4 text-center'>
        ...
        >
          <div
            className={`flex items-center text-white w-5/6 md:w-4/5 xl:w-3/6 ${
              NOTIFICATION_BACKGROUND_COLOR[notificationType || NOTIFICATION_TYPES.success]
            } shadow-md rounded-lg overflow-hidden mx-auto fixed mt-24 top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2`}
            style={{
              zIndex: '70',
            }}
          >
