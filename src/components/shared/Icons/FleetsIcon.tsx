...
const FleetsIcon = () => (
  ...
  >
    <g>
      <path
        d='M22.9,11.8h-6.3c-0.1,0-0.3-0.1-0.3-0.3l-0.1-4.7c0-0.2,0.1-0.3,0.3-0.3h5.1c0.1,0,0.2,0.1,0.3,0.2l1.3,4.8
		C23.2,11.7,23.1,11.8,22.9,11.8L22.9,11.8z M16.9,11.2h5.7l-1.1-4.1h-4.6L16.9,11.2L16.9,11.2z'
      />
      <path
        d='M22.9,16.3h-0.8c-0.4-1-1.3-1.7-2.3-1.7s-1.9,0.7-2.3,1.7h-0.8c-0.2,0-0.3-0.1-0.3-0.3v-4.5
      ...
      />
      <path
        d='M17.3,18.8h-6.9c0.1-0.3,0.2-0.7,0.2-1.1c0-0.8-0.2-1.5-0.7-2h7.8c-0.4,0.5-0.7,1.3-0.7,2
      ...
      />
      <path
        d='M2.2,12.8l4.9-7.4C7,4.9,6.8,4.2,6.9,4l0.2-0.1h1.2c0.1,0,0.2,0.1,0.2,0.2c0.3,0.7,0.5,0.9,0.5,1.1H8.7
		c-0.2,0-0.5,0.1-0.6,0.4l-4.9,7.4L2.2,12.8L2.2,12.8z'
      />
      <path
        d='M8,20.1c-1.2,0-2.1-1.1-2.1-2.5c0-1.4,0.9-2.5,2.1-2.5s2.1,1.1,2.1,2.5C10.1,19,9.2,20.1,8,20.1L8,20.1z
      ...
      />
      <polygon points='15.8,13.3 15,13.3 15,10.6 15.8,10.6 15.8,11.5 	' />
      <path d='M22.9,11.8c-0.2,0-2.3-1.5-2.6-1.7c-0.3-0.2,0-0.7,0.3-0.5l2.5,1.7C23.3,11.4,23.2,11.8,22.9,11.8L22.9,11.8z' />
      <path
        d='M20.1,10.7c-0.2,0-0.3-0.3-0.2-0.5L20.5,9c0.2-0.4,0.6,0,0.5,0.3l-0.6,1.2C20.3,10.6,20.2,10.7,20.1,10.7
		L20.1,10.7z'
      />
      <path d='M23.1,20.1h-22c-0.3,0-0.3-0.6,0-0.6h22C23.5,19.5,23.5,20.1,23.1,20.1z' />
    </g>
  </svg>
);
