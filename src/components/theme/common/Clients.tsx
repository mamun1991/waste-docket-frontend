...
//images
import amazon from '../../../../public/assets/images/brands/amazon.svg';
import google from '../../../../public/assets/images/brands/google.svg';
import paypal from '../../../../public/assets/images/brands/paypal.svg';
import spotify from '../../../../public/assets/images/brands/spotify.svg';
import shopify from '../../../../public/assets/images/brands/shopify.svg';
          ...
          <div className='container' data-aos='fade-up' data-aos-duration='300'>
            <div className='text-center'>
              ...
              <p className='text-gray-500'>
                ...
                <span className='text-primary'>Prompt</span> to drive perfomance & engagement
              </p>
            </div>
            ...
            <div className='flex flex-wrap items-center justify-center lg:gap-24 gap-10 mt-14'>
              {(brands ?? []).map((image, idx) => {
                return (
                  <div key={idx}>
                    <Image width={96} height={32} alt='app' src={image} className='h-8' />
                  </div>
                );
              })}
            </div>
