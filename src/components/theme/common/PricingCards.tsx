  ...
  return (
    <div className='container relative'>
      <div className='text-center'>
        <span className='text-3xl font-bold bg-primary/10 text-primary/90 rounded-full px-2 py-1'>
          Plans
        </span>
      ...
      <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-7 mt-14'>
                  ...
                  <div className='flex flex-col h-full'>
                    <div className='shrink'>
                      ...
                      <h1 className='text-xl font-bold mt-3'>
                        ...
                        <sub className='text-gray-500 text-sm font-normal'>/month</sub>
                      </h1>
                    </div>
                    ...
                    <div className='grow flex flex-col h-full'>
                      <div className='grow flex flex-col gap-4'>
                        {pricingCards[title].features.map((feature, idx) => {
                          return (
                            <p className='flex items-center text-gray-600 gap-4' key={idx}>
